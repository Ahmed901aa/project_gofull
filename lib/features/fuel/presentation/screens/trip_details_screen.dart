...
class TripDetailsScreen extends StatelessWidget {
  ...
  Widget _buildContent(BuildContext context, ServiceRequestEntity req) {
    ...
    final quantity = req.fuelQuantity != null ? '${req.fuelQuantity} لتر' : '—';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _section('الموقع', TripLocationCard(address: req.driverAddress ?? '—')),
          SizedBox(height: Insets.s16),
          ...
          _section(
            'ملخص الدفع',
            TripPaymentCard(
              subtotal: req.subtotal != null ? '${req.subtotal} $cur' : '— $cur',
          ...
          if (ratingValue != null) ...[
            ...
            _section(
              ...
              Container(
                ...
                child: Row(children: [
                  Icon(Icons.star_rounded, size: 24.sp, color: const Color(0xFFFFB800)),
                  SizedBox(width: 8.w),
                  Text('$ratingValue / 5',
