  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(l10n.quickAccess, style: getBoldStyle(color: context.colors.textPrimary, fontSize: FontSize.s16)),
        SizedBox(height: Insets.s12),
        QuickShortcutsRow(onNavigate: onNavigate),
        SizedBox(height: Insets.s24),
        Text(l10n.allServices, style: getBoldStyle(color: context.colors.textPrimary, fontSize: FontSize.s16)),
        SizedBox(height: Insets.s12),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Icon(Icons.search_off_rounded, size: 48.sp, color: context.colors.border),
        SizedBox(height: Insets.s12),
        Center(child: Text(S.of(context).noResults, style: getBoldStyle(color: context.colors.textPrimary, fontSize: FontSize.s16))),
        SizedBox(height: 4.h),
        Center(child: Text(S.of(context).tryDifferentSearch, style: getRegularStyle(color: context.colors.textSecondary, fontSize: FontSize.s14))),
      ],
    );
  }
}
