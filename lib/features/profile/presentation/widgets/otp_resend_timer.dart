        ...
        children: [
          ...
          seconds == 0
              ? WidgetSpan(child: GestureDetector(
                  onTap: onResend,
                  child: Text(S.of(context).resendCode, style: getMediumStyle(color: const Color(0xFF0E0E0E), fontSize: FontSize.s14)),
                ))
              : TextSpan(text: '${S.of(context).resendCode} $_formattedTime', style: getMediumStyle(color: const Color(0xFF0E0E0E), fontSize: FontSize.s14).copyWith(height: 1.4)),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text(S.of(context).confirm, style: getBoldStyle(color: AppColors.white, fontSize: FontSize.s16).copyWith(height: 1.6)),
      ),
    );
  }
}
