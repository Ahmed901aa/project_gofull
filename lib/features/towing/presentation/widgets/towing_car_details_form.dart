  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(S.of(context).carTypeHint, style: getMediumStyle(color: context.colors.textPrimary, fontSize: FontSize.s16), textAlign: TextAlign.start),
          const SizedBox(height: 8),
          ServiceInputField(hint: S.of(context).enterCarType, controller: carTypeCtrl),
          const SizedBox(height: 12),
          Text(S.of(context).plateNumber, style: getMediumStyle(color: context.colors.textPrimary, fontSize: FontSize.s16), textAlign: TextAlign.start),
          const SizedBox(height: 8),
          ServiceInputField(hint: S.of(context).enterPlateNumber, controller: plateCtrl),
          const SizedBox(height: 12),
          Text(S.of(context).photoCapture, style: getMediumStyle(color: context.colors.textPrimary, fontSize: FontSize.s16), textAlign: TextAlign.start),
          const SizedBox(height: 8),
