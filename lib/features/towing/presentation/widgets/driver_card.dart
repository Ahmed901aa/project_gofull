...
class DriverCard extends StatelessWidget {
  ...
  const DriverCard({super.key, this.vehicleLabel = 'نوع الونش', this.vehicleValue = 'ونش هيدروليك'});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Row 1: avatar + name + rating — all grouped to the start (right in RTL)
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('محمود عبدالعليم', style: getBoldStyle(color: const Color(0xFF0E0E0E), fontSize: FontSize.s16)),
                    SizedBox(height: 4.h),
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: Insets.s8, vertical: 4.h),
                      decoration: BoxDecoration(color: AppColors.neutral200, borderRadius: BorderRadius.circular(AppRadius.s16), border: Border.all(color: const Color(0xFFEFF0F1))),
